Contributing to Pivxcoin Core
==================================

The Pivxcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Pivxcoin Core project, and is not to be
confused with overall Pivxcoin Network Protocol consensus changes.

Whether a pull request is merged into Pivxcoin Core rests with the project merge
...
Patches that change Pivxcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Pivxcoin consensus, it must have been
...
The project leader is the release manager for each Pivxcoin Core release.
