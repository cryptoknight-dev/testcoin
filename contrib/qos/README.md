...
This means one can have an always-on pivxcoind instance running, and another local pivxcoind/pivxcoin-qt instance which connects to this node and receives blocks from it.
