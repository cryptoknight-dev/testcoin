...
RESOURCES += src/qt/pivxcoin.qrc src/qt/pivxcoin_locale.qrc

TRANSLATIONS += src/qt/locale/pivxcoin_bg.ts \
                src/qt/locale/pivxcoin_de.ts \
                src/qt/locale/pivxcoin_en.ts \
                src/qt/locale/pivxcoin_es.ts \
                src/qt/locale/pivxcoin_fi.ts \
                src/qt/locale/pivxcoin_fr.ts \
                src/qt/locale/pivxcoin_it.ts \
                src/qt/locale/pivxcoin_ja.ts \
                src/qt/locale/pivxcoin_pl.ts \
                src/qt/locale/pivxcoin_pt.ts \
                src/qt/locale/pivxcoin_ru.ts \
                src/qt/locale/pivxcoin_sk.ts \
                src/qt/locale/pivxcoin_sv.ts \
                src/qt/locale/pivxcoin_vi.ts \
                src/qt/locale/pivxcoin_zh_CN.ts \
                src/qt/locale/pivxcoin_zh_TW.ts
