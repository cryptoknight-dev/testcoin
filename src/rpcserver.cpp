...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Pivxcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Pivxcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivxcoin features */
        {"pivxcoin", "masternode", &masternode, true, true, false},
        {"pivxcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"pivxcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pivxcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pivxcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pivxcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"pivxcoin", "startmasternode", &startmasternode, true, true, false},
        {"pivxcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pivxcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pivxcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pivxcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pivxcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pivxcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pivxcoin", "mnbudget", &mnbudget, true, true, false},
        {"pivxcoin", "preparebudget", &preparebudget, true, true, false},
        {"pivxcoin", "submitbudget", &submitbudget, true, true, false},
        {"pivxcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pivxcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pivxcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pivxcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pivxcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pivxcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pivxcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pivxcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"pivxcoin", "mnsync", &mnsync, true, true, false},
        {"pivxcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> pivxcoin-cli " + methodname + " " + args + "\n";
}
