...
/** Utility functions used by the Pivxcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render PIV addresses in monospace font
...
// Parse "pivxcoin:" URI into recipient object, return true on successful parsing
