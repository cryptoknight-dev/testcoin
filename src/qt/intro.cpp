...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Pivxcoin Core"),
     ...
     * override -datadir in the pivxcoin.conf file in the default data directory
     * (to be consistent with pivxcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
