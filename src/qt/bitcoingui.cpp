...
// Copyright (c) 2017-2018 The Pivxcoin Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Pivxcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PIV address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pivxcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pivxcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pivxcoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Pivxcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PIV addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PIV addresses"));
    ...
    openNetworkAction = new QAction(QIcon(":/icons/connect_4_black"), tr("&Network Monitor"), this);
    openNetworkAction->setStatusTip(tr("Show network monitor"));
    openPeersAction = new QAction(QIcon(":/icons/connect_4_black"), tr("&Peers list"), this);
    ...
    openAction->setStatusTip(tr("Open a pivxcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pivxcoin Coin help message to get a list with possible Pivxcoin Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/pivxcoin_logo_horizontal").pixmap(210, 50));
    ...
    if (enableWallet) {
       ...
       if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        ...
        frameToolbar->setStyleSheet(".QFrame { margin-left:-0px; background-color: #000000; }");
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Pivxcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pivxcoin network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    // TODO: Prevent orphan statusbar messages (e.g. hover Quit in main menu, wait until chain-sync starts -> garbelled text)
...
{
    QString strTitle = tr("Pivxcoin Core"); // default title
