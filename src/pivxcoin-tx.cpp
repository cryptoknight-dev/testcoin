...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pivxcoin Core pivxcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pivxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pivxcoin transaction") + "\n" +
                               "  pivxcoin-tx [options] -create [commands]   " + _("Create hex-encoded pivxcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pivxcoin transaction
