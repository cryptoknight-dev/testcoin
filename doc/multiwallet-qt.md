...
In order to support loading of multiple wallets in pivxcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pivxcoin.cpp.
...
Changes to pivxcoin.cpp
----------------------
pivxcoin.cpp is the entry point into pivxcoin-qt, and as such, will require some minor modifications to provide hooks for
