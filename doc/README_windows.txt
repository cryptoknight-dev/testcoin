...
Intro
-----
Pivxcoin (PIV) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Pivxcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run pivxcoin-qt.exe.

Pivxcoin Core is the original Pivxcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Pivxcoin transactions;
